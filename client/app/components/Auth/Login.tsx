...
const Login: FC<Props> = ({ setRoute, setOpen, refetch }) => {
    ...
    useEffect(() => {
        ...
        },[isSuccess, error, setRoute, setOpen, refetch]);
    ...
    return (
        <div className='w-full'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type='email' value={values.email} name='' onChange={handleChange} id='email' placeholder='loginmail@gmail.com' className={`${errors.email && touched.email && "border-red-500"} ${styles.input}`} />
