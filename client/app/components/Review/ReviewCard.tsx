...
const ReviewCard = (props: Props) => {
  return (
    <div className="w-full h-max pb-4 dark:bg-slate-500 dark:bg-opacity-[0.20] backdrop:blur border dark:border-[#ffffff1d] border-[#00000028] rounded-lg p-3 shadow-[bg-slate-700] ">
